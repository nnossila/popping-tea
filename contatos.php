...
<head>
    ...
    <title>Popping Tea - Contatos</title>
    ...
    <main class="contato-container">
        <section class="faq-form-wrapper">
            <div class="faq-box">
                ...
                <div class="faq-item">
                    <h4>Fazem entrega?</h4>
                    <p>Sim! Entregamos via iFood, Rappi e WhatsApp. Atendemos toda a região urbana de Curitiba, com entregas rápidas e seguras.</p>
                </div>
                <div class="faq-item">
                ...
                <div class="faq-item">
                    ...
                    <p>Temos opções com e sem lactose. Consulte o cardápio para detalhes.</p>
                </div>
            ...
            <div class="form-box">
                ...
                <form id="form-contato">
                    ...
                    <p class="mensagem-sucesso" id="mensagem-sucesso">Mensagem enviada com sucesso!</p>
                </form>
            </div>
        </section>
    </main>
